    ...
    return (
        <>
            ...
            <div className="bg-[#FFFEF7] w-full m-0 p-0 overflow-hidden pb-10 md:pb-20">
                <svg xmlns="http://www.w3.org/2000/svg" width="1440" height="175" viewBox="0 0 1440 175" fill="none" className="max-md:relative max-md:-left-44 lg:w-full h-32.75 lg:h-auto">
