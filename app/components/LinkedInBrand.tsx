                ...
                <div className="flex flex-col md:flex-row justify-between gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                            ...
                            <button className="bg-white text-[#361E98] w-full sm:w-45 h-12.5 lg:ml-9 py-3 rounded-[100px] inline-flex items-center justify-center gap-2 whitespace-nowrap">
