...
export default function LinkedInBrand() {
    ...
    return (
        <section className="bg-[#FFF] max-md:px-20 pt-16 md:pt-33.75 pb-16 md:pb-16 lg:pb-24">
            <section
                ...
                <div className="flex flex-col md:flex-row justify-between gap-8">
                    {/* Left content */}
                    <div>
                        <h1 className="text-[clamp(24px,5vw,32px)] sm:text-[48px] lg:text-[64px] font-black mb-3 leading-tight lg:leading-16.25 uppercase">
                            complimentary
                            <br />
                            linkedin branding
                        </h1>
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                            <div className="flex items-center -space-x-6">
                                <div className="w-12.5 h-12.5 rounded-full">
                                    <Image src={"/li/test-1.svg"} width={50} height={50} alt="person-testimony" />
                                </div>
                                <div className="w-12.5 h-12.5 rounded-full">
                                    <Image src={"/li/test-2.svg"} width={50} height={50} alt="person-testimony" />
                                </div>
                                <div className="w-12.5 h-12.5 rounded-full">
                                    <Image src={"/li/test-3.svg"} width={50} height={50} alt="person-testimony" />
                                </div>
                            </div>
