            ...
            <div className="bg-[#361E98] rounded-[21px] sm:rounded-[28px] lg:rounded-[30px] w-full max-w-380 mx-auto overflow-hidden relative px-[16px] py-[10px] sm:px-[24px] sm:py-[16px] lg:px-[32px] lg:py-[17px]">
                ...
                <div className="flex items-center justify-between w-full mb-[2px] sm:mb-[4px] lg:mb-0">
                    ...
                    <svg className="w-[14px] h-[12px] sm:w-[20px] sm:h-[17px] lg:w-[28px] lg:h-[24px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 18" fill="none">
                        ...
                        <path d="M7.00977 8.68915L9.00385 10.4218L12.992 6.95654" stroke="#361E98" stroke-width="1.42857" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="relative shrink-0 self-end w-[90px] h-[100px] min-[480px]:w-[130px] min-[480px]:h-[130px] sm:w-[200px] sm:h-[180px] md:w-[340px] md:h-[260px] lg:w-[470px] lg:h-[340px]">
                        ...
                        <motion.div
                            className="absolute -left-15 -bottom-10 min-[480px]:-left-14 min-[480px]:-bottom-10 sm:-left-6 sm:-bottom-15 md:-left-15 lg:left-0 md:-bottom-15 lg:-bottom-20 origin-bottom"
                            {...hoverStandUp}
                        >
                            <div
                        ...
                        <motion.div
                            className="absolute -left-[20%] -bottom-5 min-[480px]:left-[2%] min-[480px]:-bottom-5 sm:left-[22%] sm:-bottom-10 md:left-[20%] lg:left-[33%] xl:left-[28%] md:-bottom-8 lg:-bottom-10 z-10 origin-bottom"
                            {...hoverStandUp}
                        >
                            <div
