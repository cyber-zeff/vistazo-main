...
export default function OPCard() {
    ...
    return (
        <section id='processes' className="bg-[#FFFEF7] px-[clamp(1rem,5vw,5rem)] py-[clamp(3rem,8vw,5rem)]">
            ...
            <div className="flex justify-center">
                <div className="lg:max-w-208 grid grid-cols-1 min-[840px]:grid-cols-2 place-items-center max-sm:px-10">
                    <OPCardCol1 />
                    <OPCardCol2 />
                </div>
            </div>
